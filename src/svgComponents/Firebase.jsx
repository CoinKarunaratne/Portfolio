...
const SvgFirebase = (props) => (
  ...
  >
    ...
    <path
      ...
      fill="#FFC24A"
    />
    <use fill="#FFA712" fillRule="evenodd" xlinkHref="#firebase_svg__a" />
    <use filter="url(#firebase_svg__b)" xlinkHref="#firebase_svg__a" />
    <path
      d="m135.005 150.38 32.955-33.75-32.965-62.93c-3.129-5.957-11.866-5.975-14.962 0L102.42 87.287v2.86l32.584 60.233Z"
      fill="#F4BD62"
    />
    <use fill="#FFA50E" fillRule="evenodd" xlinkHref="#firebase_svg__c" />
    <use filter="url(#firebase_svg__d)" xlinkHref="#firebase_svg__c" />
    <path
      fill="#F6820C"
